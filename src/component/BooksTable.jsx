                ...
                <tbody>
                    {
                        books.map((book, index) => (
                            <tr key={book._id} className="h-8">
                                ...
                                <td className="border border-slate-800 rounded-md text-center mx-md-hidden">{book.author}</td>
                                <td className="border border-slate-800 rounded-md text-center mx-md-hidden">{book.publishYear}</td>
